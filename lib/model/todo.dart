...
class ToDo {
  ...
  static List<ToDo> todoList() {
    ...
    return [
      ToDo(
          id: '1',
          todoText: 'Attend morning prayer',
          isDone: true), // A completed task
      ToDo(
          id: '2',
          todoText: 'Take kids to school',
          isDone: true), // A completed task
      ToDo(id: '3', todoText: 'Call mum', isDone: true), // A completed task
      ToDo(id: '4', todoText: 'Do physical exercise'), // An incomplete task
      ToDo(
          id: '5',
          todoText: 'Visit my doctor for check up'), // An incomplete task
      ToDo(id: '6', todoText: 'Attend PLP Flutter class'), // An incomplete task
    ];
  }
}
