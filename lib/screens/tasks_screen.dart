...
// Define a method to show the help dialog
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          title: Text("Help"),
          content: const Text(
            "Here's how to use the To-Do list app:\n"
            "- Add a new Todo item by tapping the '+' button.\n"
            "- Mark an item as completed by checking the box.\n"
            "- Delete a todo item by tapping the trash icon.\n"
            "- Use the drawer to navigate between all tasks, completed tasks, and pending tasks.",
          ),
          actions: [
            TextButton(
              onPressed: () {
              ...
              child: const Text("OK"), // Action to close the dialog
            ),
          ],
        );
      },
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration:
                const InputDecoration(hintText: 'Enter new Todo item...'),
          ),
          actions: [
            TextButton(
              onPressed: () {
          ...
          children: [
            const UserAccountsDrawerHeader(
              currentAccountPicture: CircleAvatar(
                backgroundImage: AssetImage("assets/kweka.jpeg"),
              ),
              accountName: Text("Ashirafu Kweka"),
              accountEmail: Text("kwekaashraf@gmail.com"),
            ),
            ...
            ListTile(
              ...
              onTap: () {
                _showHelpDialog(
                    context); // Call the method to show the help dialog
              },
            ),
            ListTile(
              title: Text("Logout"),
